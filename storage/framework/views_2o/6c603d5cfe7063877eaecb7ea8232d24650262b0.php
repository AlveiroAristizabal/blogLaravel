<nav class="bg-gray-800" x-data="{open:false}">
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          ...
          <!-- Profile dropdown ALV menu q no recoge-->
          <div class="ml-3 relative" x-data="{open: false}">
            ...
            <div x-show="open" x-on:click.away="open = false" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
              <a href="<?php echo e(route('profile.show')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">tu perfil</a>
              
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.home')): ?>
              <a href="<?php echo e(route('admin.home')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">dashboard</a>
              <?php endif; ?>
    ...
    <!-- ALV este es de la izq OJO --Mobile menu, show/hide based on menu state. -->
  ...
  <?php /**PATH C:\xampp\htdocs\blog\resources\views/livewire/navigation.blade.php ENDPATH**/ ?>