...
class RoleSedder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission = Permission::create(['name' => 'admin.tags.create'])->syncRoles([$role1]);
        $permission = Permission::create(['name' => 'admin.tags.edit'])->syncRoles([$role1]);
        $permission = Permission::create(['name' => 'admin.tags.destroy'])->syncRoles([$role1]);
        ...
        $permission = Permission::create(['name' => 'admin.posts.destroy'])->syncRoles([$role1, $role2]);
